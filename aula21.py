...
class Application(Funcs, Relatorios):
    ...
    def frames_da_tela(self):
        ...
        self.frame_1.place(relx= 0.02, rely=0.02, relwidth= 0.6, relheight= 0.46)

        self.frame_2 = Frame(self.root, bd=4, bg='#dfe3ee',
                             highlightbackground='#759fe6', highlightthickness=3)
        self.frame_2.place(relx=0.02, rely=0.5, relwidth=0.6, relheight=0.46)

        self.frame_3 = Frame(self.root, bd=4, bg='#dfe3ee',
                             highlightbackground='#759fe6', highlightthickness=3)
        self.frame_3.place(relx=0.64, rely=0.02, relwidth=0.34, relheight=0.94)
    ...
    def widgets_frame3(self):
        self.abas = ttk.Notebook(self.frame_3);
        ...
        self.label1 = Label(self.frame_aba1, text="teste");
        self.label1.pack(side = "top")

        ########################################################
        #### drop down button
        self.Tipvar = StringVar()
        self.TipV = ("Solteiro(a)", "Casado(a)", "Divorciado(a)")
        self.Tipvar.set("Solteiro(a)")
        self.popupMenu = OptionMenu(self.frame_aba1, self.Tipvar, *self.TipV)
        self.popupMenu.place(relx= 0.1, rely=0.1, relwidth=0.4, relheight=0.075)
