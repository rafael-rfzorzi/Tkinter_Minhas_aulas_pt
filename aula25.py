...
class Application(Funcs, Relatorios, Validadores):
    ...
    def validaEntradas(self):
        ...
        self.vcmd8 = (self.root.register(self.validate_entry8), "%P")
        self.vcmd6 = (self.root.register(self.validate_entry6), "%P")
        self.vcmd4 = (self.root.register(self.validate_entry4), "%P")
        self.vcmd2 = (self.root.register(self.validate_entry2), "%P")
        self.vcmd8float = (self.root.register(self.validate_entry8float), "%P")
        self.vcmd9float = (self.root.register(self.validate_entry9float), "%P")
        self.vcmd4float = (self.root.register(self.validate_entry4float), "%P")
